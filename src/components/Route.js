    ...
    return (
        <div className="card flex flex-col md:flex-row gap-5 max-w-full overflow-x-auto" {...props}>
            <div className="grow w-fit">
                ...
                <table className="table table-auto border-x border-t border-neutral-300 dark:border-neutral-700 min-w-[640px] mt-2">
                    <thead className="table-header-group">
                        <tr className="table-row">
                            <th className="table-cell text-left p-3 border-b border-b-neutral-300 dark:border-b-neutral-700 w-2/12">Name</th>
                            <th className="table-cell text-left p-3 border-b border-b-neutral-300 dark:border-b-neutral-700 w-2/12">Data Type</th>
                            <th className="table-cell text-left p-3 border-b border-b-neutral-300 dark:border-b-neutral-700 w-1/12">Default</th>
                            <th className="table-cell text-left p-3 border-b border-b-neutral-300 dark:border-b-neutral-700 w-7/12">Description</th>
                        </tr>
                    </thead>
                    <tbody className="table-row-group">
                        {
                            query.map((param, index) => (
                                <tr className="table-row border-b border-b-neutral-300 dark:border-b-neutral-700" key={index}>

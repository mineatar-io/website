    ...
    return (
        <>
            <section>
                ...
                <p className="leading-7 mt-3">Mineatar was built to be an alternative to existing Minecraft skin API services which improves the speed and efficiency of rendering Minecraft player skins as 3-dimensional images. Everything was built from the ground-up using <a href="https://go.dev" className="link">Go</a> as the language of choice for extreme performance, and this website was built using <a href="https://nextjs.org" className="link">NextJS</a>. </p>
            </section>
            ...
            <section className="pt-12">
                ...
                <p className="mt-1">If you would like to contact us, you can do so by sending an email to <a href="mailto:contact@mineatar.io" className="link">contact@mineatar.io</a> or joining our <a href="https://discord.gg/QwvzbA9KGz" className="link">Discord server</a>.</p>
            </section>
        </>
    );
}